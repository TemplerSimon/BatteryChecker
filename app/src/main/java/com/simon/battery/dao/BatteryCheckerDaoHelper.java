...
public class BatteryCheckerDaoHelper extends OrmLiteSqliteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, ConnectionSource connectionSource,
        ...
        try {
            Log.i(BatteryCheckerDaoHelper.class.getName(), "onUpgrade");
     ...
     */
    public Dao<BatteryModel, Integer> getBatteryCheckerDao()
            throws SQLException {
        if (batteryModelDao == null) {
            batteryModelDao = getDao(BatteryModel.class);
        }
        return batteryModelDao;
    }

    public Dao<DisChargingModel, Integer> getDisChargingBatteryDao()
            throws SQLException {
        if (batteryDisChargingDao == null) {
            batteryDisChargingDao = getDao(DisChargingModel.class);
        }
     ...
     */
    public RuntimeExceptionDao<BatteryModel, Integer> getBatteryCheckerDataDao() {
        if (batteryModelRuntimeDao == null) {
            batteryModelRuntimeDao = getRuntimeExceptionDao(BatteryModel.class);
        }
        return batteryModelRuntimeDao;
    }

    public RuntimeExceptionDao<DisChargingModel, Integer> getDisChargingModelDao() {
        if (batteryDisChargingRuntimeDao == null) {
            batteryDisChargingRuntimeDao = getRuntimeExceptionDao(DisChargingModel.class);
        }
